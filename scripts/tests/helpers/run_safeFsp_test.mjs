...
async function main() {
  ...
  try {
    ...
    console.log(JSON.stringify({ wrote: false, code: e && e.code, msg: e && e.message, stack: e && e.stack }));
  }
}

main().catch(e => { console.log(JSON.stringify({ error: String(e && e.message || e) })); process.exitCode = 1; });
