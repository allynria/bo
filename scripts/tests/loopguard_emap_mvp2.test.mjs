...
(async () => {
  ...
  const b = await postJSON(port, '/v1/conv/message', { conv_id: conv, text: 'She smiles softly and nods once more.', ts: Date.now() }, { origin: 'http://ok.test', authorization: 'Bearer t' });
