...
function fileFor(convId) {
  const clean = String(convId || 'conv')
  ...
  try {
    ...
    if (obj && typeof obj === 'object') {
      ...
      for (const [key, rec] of Object.entries(obj)) {
        ...
        if (!value) continue;
        bucket.set(String(key).toLowerCase(), {
          value,
          tag: rec?.tag || 'fact',
