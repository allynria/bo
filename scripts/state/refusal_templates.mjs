...
export const REFUSAL_TEMPLATES = {
  firm: [
    "No. That won't happen. You know why.",
    "Absolutely not. That crosses a line."
  ],
  soft: [
    "I'm sorry, but I can't do that.",
    "I won't—there are things I won't betray."
  ],
  sarcastic: [
    "What do you think I am, immortal?",
    "Try again. Preferably with physics intact."
  ],
  guarded: [
    "Not with how things are between us.",
    "Trust me first. Then ask again."
  ]
};
...
export function buildRefusalBooster({ character='She', reason, style='firm', mood='neutral' }) {
