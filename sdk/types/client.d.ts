...
export type ErrorCode =
    ...
    | 'not_found'
    | 'ts_required';
// Canonical error object schemas
...
export type StreamEvent = {
    event: 'start';
    payload: SSEStartPayload;
} | {
    event: 'delta';
    payload: SSEDeltaPayload;
} | {
    event: 'hedge.switch';
    payload: SSEHedgeSwitchPayload;
} | {
    event: 'end';
    payload: SSEEndPayload;
} | {
    event: 'error';
    payload: ErrorResponse;
};
export { postV1ConvMessage, postV1ConvCompile, subscribeV1ConvStream, iterateV1ConvStream } from '../js/client.mjs';
